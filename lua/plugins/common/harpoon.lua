...
vim.keymap.set("n", "<leader><leader>", function() require("harpoon"):list():add() end)
vim.keymap.set("n", "<leader>.", function() require("harpoon").ui:toggle_quick_menu(require("harpoon"):list()) end)
